...
class FixCommand:
    ...
    @staticmethod
    def _run_fixes(ps2, fix_style, fix_imports, fix_conflicts, actually_fix, verbose=False) -> list:
        """
    ...
    def _build_aggregate_result(results, dry_run) -> dict:
        ...
        for name, result in results:
            ...
            if result.get("status") == "fail":
                ...
                aggregate_result["message"] = "Some issues could not be fixed automatically"
    ...
    def execute(args: argparse.Namespace, ps2: Any) -> int:
        ...
        fix_style, fix_imports, fix_conflicts, actually_fix = FixCommand._determine_fixes(args)
