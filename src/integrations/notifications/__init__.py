...
allowing PS2 to send notifications via email, Slack, Microsoft Teams,
...
# Registry of available notification service adapters
_notification_service_registry = {}
...
def register_notification_service(
    ...
    Args:
        service_type: Type of notification service (e.g., 'email', 'slack', 'teams').
    ...
    try:
        return _extracted_from_register_notification_service_24(service_type, config)
    except ImportError:
...
# TODO Rename this here and in `register_notification_service`
def _extracted_from_register_notification_service_24(service_type, config):
    # Import the appropriate adapter module
    module_name = f"ps2.integrations.notifications.{service_type}_adapter"
...
def supported_notification_services() -> List[str]:
    ...
    """
    # In a full implementation, this would dynamically discover adapters
    # For now, return a static list of supported services
